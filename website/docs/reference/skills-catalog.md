...
| [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-linket-agent) | Configure, extend, or contribute to Hermes Agent. | `autonomous-ai-agents/linket-agent` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-linket-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-linket-tui-commands) | Debug Hermes TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-linket-tui-commands` |
