...
- User wants **Linket itself to drive a browser** → use Linket' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
