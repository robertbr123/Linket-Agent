...
| | |
|---|---|
| Source | Optional — install with `linket skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Linket Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.linket/.env`:
