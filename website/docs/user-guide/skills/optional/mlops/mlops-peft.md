...
| | |
|---|---|
| Source | Optional — install with `linket skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/robertbr123/Linket-Agent/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/robertbr123/Linket-Agent/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
