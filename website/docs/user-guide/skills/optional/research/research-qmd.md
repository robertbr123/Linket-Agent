...
| | |
|---|---|
| Source | Optional — install with `linket skills install official/research/qmd` |
...
Linket Agent via the native MCP client. This is the preferred
...
Then configure Linket Agent to connect via HTTP:
