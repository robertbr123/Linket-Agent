...
To reply non-interactively from Linket, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from Linket)** — pipe the message via stdin:
