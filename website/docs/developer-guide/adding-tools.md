...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Linket Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Linket tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Linket core, use the plugin route instead:

- [Plugins](/docs/user-guide/features/plugins)
- [Build a Linket Plugin](/docs/guides/build-a-linket-plugin)
...
- [ ] Tested with `linket chat -q "Use the weather tool for London"`
