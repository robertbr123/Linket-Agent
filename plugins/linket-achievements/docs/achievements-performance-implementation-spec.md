# Linket Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.linket/plugins/linket-achievements/state.json` (existing unlock state)
  - `~/.linket/plugins/linket-achievements/scan_snapshot.json` (new)
  - `~/.linket/plugins/linket-achievements/scan_checkpoint.json` (new)
