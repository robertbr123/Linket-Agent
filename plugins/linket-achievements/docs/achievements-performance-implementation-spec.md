...
- persisted runtime files:
  - `~/.hermes/plugins/linket-achievements/state.json` (existing unlock state)
  - `~/.hermes/plugins/linket-achievements/scan_snapshot.json` (new)
  - `~/.hermes/plugins/linket-achievements/scan_checkpoint.json` (new)
