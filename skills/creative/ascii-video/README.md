...
Built for [Linket Agent](https://github.com/robertbr123/Linket-Agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/linket-agent/skills/creative/ascii-video`](https://github.com/robertbr123/Linket-Agent/tree/main/skills/creative/ascii-video) via PR.
