...
def _find_migration_script() -> Path | None:
    """Find the openclaw_to_linket.py script in known locations."""
...
def _load_migration_module(script_path: Path):
    ...
    spec = importlib.util.spec_from_file_location("openclaw_to_linket", script_path)
